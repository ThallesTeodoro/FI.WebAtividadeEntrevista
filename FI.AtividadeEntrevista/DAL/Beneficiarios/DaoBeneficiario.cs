...
namespace FI.AtividadeEntrevista.DAL
{
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        /// <summary>
        /// Excluir beneficiario pelo id do cliente
        /// </summary>
        /// <param name="cliente">Objeto de beneficiario</param>
        internal void ExcluirPeloIdCliente(long IdCliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("IdCliente", IdCliente));

            base.Executar("FI_SP_DelBeneficiarioByCliente", parametros);
        }

        /// <summary>
        /// Consultar beneficiario por cliente
        /// </summary>
